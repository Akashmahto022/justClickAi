...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const prompt = `Write an article about the ${input} in ${selectedLength.text}`;

      const { data } = await axios.post('/api/ai/generate-article', { prompt, length: selectedLength.text }, {
